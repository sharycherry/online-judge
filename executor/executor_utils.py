...
IMAGE_NAME = "yuesheng941101/soj-executor"
...
def build_and_run(code, lang):
    ...
    print('here' + source_file_host_dir)
...
def make_dir(dirpath):
    try:
        os.mkdir(dirpath)
        print("Temp build directory [%s] created." % dirpath)
    except OSError:
        print("Temp build directory [%s] exists." % dirpath)
